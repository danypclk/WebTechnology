...
function checkservices() 
{
	...
	if(client_name_Value != '' && client_email_Value != '' && client_address_Value != '' &&(document.querySelectorAll('input[type="radio"][value="Cleaning"]:checked').length === 1 || document.querySelectorAll('input[type="radio"][value="Repair"]:checked').length === 1 || document.querySelectorAll('input[type="radio"][value="Replacement"]:checked').length === 1 || document.querySelectorAll('input[type="radio"][value="Sonstiges"]:checked').length === 1))
	{
		alert('Successfully tasked an employee!');
