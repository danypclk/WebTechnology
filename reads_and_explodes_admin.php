...
// see if register text files already exist or not,
...
// it then creates an array of all the files in the directory
// and tries to find out if all of then are empty
// if all are, the i-frame is going to display that
// there is no registry

$array = array($file ,$file_1, $file_2);
$empty = true;
